import{d as m,r as b,j as e,y as B}from"./index-CQ9Bvwu6.js";const $="var(--bg)",A="var(--card)",M="var(--text)",O="var(--muted)",v="var(--border)",U="var(--radius)",W="var(--shadow)",T="var(--accent)",P="var(--danger, #e5484d)",i={Wrapper:m.div`
        display: grid;
        gap: 16px;
        padding: 16px;
        color: ${M};

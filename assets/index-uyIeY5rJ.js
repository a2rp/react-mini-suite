import{d,r as n,R as U,j as o}from"./index-CQ9Bvwu6.js";const B="var(--card, #111)",h="var(--text, #eaeaea)",g="var(--muted, #a8a8a8)",p="var(--border, #242424)",v="var(--accent, #22c55e)",_="var(--danger, #ef4444)",H="var(--radius, 16px)",K="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",c={Wrapper:d.div`
        width: 100%;
        display: grid;

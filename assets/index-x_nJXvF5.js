import{d as p,r as g,j as e,y as m}from"./index-CQ9Bvwu6.js";const x="var(--bg)",S="var(--card)",f="var(--text)",k="var(--muted)",b="var(--border)",j="var(--radius)",B="var(--shadow)",C="var(--accent)",N="var(--danger, #e5484d)",d={Wrapper:p.div`
        background: ${x};
        color: ${f};
        min-height: 100%;
        padding: 16px;

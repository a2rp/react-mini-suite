import{d as P,r as n,j as e}from"./index-CQ9Bvwu6.js";const T="var(--card, #111)",b="var(--text, #e9e9e9)",g="var(--muted, #b7b7b7)",d="var(--border, #222)",m="var(--accent, #22c55e)",L="var(--radius, 16px)",J="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",Y={Wrapper:P.div`

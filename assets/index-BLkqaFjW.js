import{g as B,d as m,r as x,j as e}from"./index-BNmCeOvN.js";const N="var(--text, #e9e9e9)",D="var(--muted, #b7b7b7)",v="var(--border, #222)",E="var(--card, #111)",S="var(--accent, #22c55e)",F="var(--radius, 16px)",C="var(--shadow, 0 6px 24px rgba(0,0,0,.3))",I=B`
  @media print {

import{d,r as s,_ as C,j as a}from"./index-CVh2HO98.js";const _="var(--card, #111)",v="var(--text, #e9e9e9)",b="var(--muted, #b7b7b7)",h="var(--border, #222)",f="var(--accent, #22c55e)",N="var(--radius, 16px)",E="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",k=d.div`
    max-width: 900px;
    margin: 0 auto;
    padding: 24px;
    color: ${v};

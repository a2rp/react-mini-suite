import{d as p,r as l,j as e}from"./index-CQ9Bvwu6.js";const j="var(--bg)",S="var(--card)",v="var(--text)",N="var(--muted)",h="var(--border)",g="var(--radius)",I="var(--shadow)",L="var(--accent)",_="var(--danger, #e5484d)",s={Wrapper:p.div`
        display: grid;
        gap: 16px;
        padding: 16px;
        color: ${v};

import{d as g,r as f,j as e}from"./index-CVh2HO98.js";const N="var(--bg)",C="var(--card)",S="var(--text)",A="var(--muted)",h="var(--border)",j="var(--radius)",V="var(--shadow)",E="var(--accent)",k="var(--danger, #e5484d)",n={Wrapper:g.div`
        background: ${N};
        color: ${S};
        min-height: 100%;
        padding: 16px;

import{d as D,r as $,j as e}from"./index-CQ9Bvwu6.js";const m="var(--card, #111)",u="var(--text, #e9e9e9)",C="var(--muted, #b7b7b7)",h="var(--border, #222)",q="var(--accent, #22c55e)",S="var(--radius, 16px)",L="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",z={Wrapper:D.div`
        display: grid;
        gap: 16px;

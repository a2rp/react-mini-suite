import{d as s,r,j as e}from"./index-BNmCeOvN.js";const $="var(--bg)",u="var(--card)",v="var(--text)",g="var(--muted)",d="var(--border)",m="var(--radius)",k="var(--shadow)",p="var(--accent)",A="var(--danger, #e5484d)",l={Wrapper:s.div`
        max-width: 1440px;
        margin: 0 auto;
        display: grid;
        gap: 16px;

import{d as m,r as d,j as e}from"./index-CQ9Bvwu6.js";const k="var(--card, #0f1012)",b="var(--text, #eaeaea)",u="var(--muted, #a8a8a8)",l="var(--border, #242424)",$="var(--accent, #22c55e)",j="var(--radius, 16px)",z="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",h={Wrapper:m.div`
        display: flex;

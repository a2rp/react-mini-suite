import{d as l,f as G,r as p,j as e}from"./index-CQ9Bvwu6.js";const T="var(--card, #111)",u="var(--text, #e9e9e9)",A="var(--muted, #b7b7b7)",S="var(--border, #222)",j="var(--accent, #22c55e)",I="var(--radius, 16px)",z="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",P="var(--maxw, 1100px)",q=`
  display: block;
  font-size: 0.9rem;
  color: ${A};
  margin-bottom: 6px;

import{d as s,l as ie,r as b,j as e}from"./index-CVh2HO98.js";const N="var(--bg)",$="var(--card)",w="var(--text)",D="var(--muted)",x="var(--border)",f="var(--radius)",J="var(--shadow)",U="var(--accent)",k="var(--danger, #e5484d)",a={Wrapper:s.div`
        max-width: 1440px;
        margin: 0 auto;
        display: grid;
        gap: 16px;

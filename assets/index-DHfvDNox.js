import{d as c,r as l,j as e}from"./index-CQ9Bvwu6.js";const w="var(--bg)",D="var(--card)",z="var(--text)",y="var(--muted)",x="var(--border)",k="var(--radius)",E="var(--shadow)",U="var(--accent)",ee="var(--danger, #e5484d)",ue="var(--pong-ball, var(--accent))",xe="var(--pong-paddle, var(--card))",re="var(--pong-paddle-border, var(--border))",o={Wrapper:c.div`
        max-width: 1440px;
        margin: 0 auto;
        padding: 16px;
        color: ${z};

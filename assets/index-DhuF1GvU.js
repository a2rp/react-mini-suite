import{d,r as c,j as e}from"./index-BNmCeOvN.js";const y="var(--bg, #0b0b0b)",v="var(--card, #111)",h="var(--text, #e9e9e9)",p="var(--muted, #a8a8a8)",u="var(--border, #222)",g="var(--accent, #22c55e)",D="var(--danger, #ef4444)",E="var(--info, #38bdf8)",N="var(--radius, 16px)",M="var(--shadow, 0 8px 30px rgba(0,0,0,.25))",z=d.div`
    color: ${h};
    max-width: 820px;
    margin: 0 auto;
    padding: 24px 16px;

import{d as c,r as m,j as n}from"./index-CVh2HO98.js";const L="var(--card, #0f1012)",x="var(--text, #eaeaea)",C="var(--muted, #a8a8a8)",g="var(--border, #242424)",$="var(--accent, #22c55e)",q="var(--danger, #ef4444)",S="var(--radius, 16px)",F="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",a={Wrapper:c.div`
        display: flex;

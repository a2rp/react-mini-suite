import{d,r as x,j as t}from"./index-BNmCeOvN.js";const j="var(--bg)",C="var(--card)",y="var(--text)",M="var(--muted)",b="var(--border)",h="var(--radius)",E="var(--shadow)",O="var(--accent)",K="var(--danger, #e5484d)",c={Page:d.div`
        color: ${y};
        background: ${j};
        min-height: 100%;
        padding: 16px;

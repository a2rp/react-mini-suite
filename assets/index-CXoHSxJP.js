import{d as l,r as d,j as e}from"./index-CQ9Bvwu6.js";const k="var(--bg)",m="var(--card)",b="var(--text)",S="var(--muted)",h="var(--border)",j="var(--radius)",_="var(--shadow)",H="var(--accent)",w="var(--danger, #e5484d)",n={Wrapper:l.div`
        display: grid;
        gap: 16px;
        padding: 16px;
        background: ${k};

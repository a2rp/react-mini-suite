import{d as b,r as j,j as t,y as E}from"./index-BNmCeOvN.js";const C="var(--bg)",R="var(--card)",U="var(--text)",O="var(--muted)",y="var(--border)",$="var(--radius)",J="var(--shadow)",k="var(--accent)",_="var(--danger, #e5484d)",c={Wrapper:b.div`
        color: ${U};
        background: ${C};
        min-height: 100%;
        padding: 16px;

import{d as s,r as a,j as e}from"./index-CQ9Bvwu6.js";const m="var(--bg)",R="var(--card)",l="var(--text)",H="var(--muted)",n="var(--border)",u="var(--radius)",V="var(--shadow)",j="var(--accent)",ie="var(--danger, #e5484d)",o={Wrapper:s.div`
        /* center page content */
        max-width: 1440px;
        margin: 0 auto;

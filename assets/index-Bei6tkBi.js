import{d,r as x,j as e}from"./index-CVh2HO98.js";const y="var(--card, #0f1012)",w="var(--text, #eaeaea)",j="var(--muted, #a8a8a8)",p="var(--border, #242424)",v="var(--accent, #22c55e)",k="var(--radius, 16px)",$="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",a={Wrapper:d.div`
        display: flex;

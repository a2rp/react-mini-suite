import{d as l,r as x,j as t}from"./index-CVh2HO98.js";const f="var(--bg)",j="var(--card)",p="var(--text)",k="var(--muted)",u="var(--border)",g="var(--radius)",E="var(--shadow)",v="var(--accent)",A="var(--danger, #e5484d)",a={Wrapper:l.div`
        /* page container */

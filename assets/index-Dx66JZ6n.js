import{d as c,f as q,r as d,j as e}from"./index-CVh2HO98.js";const R="var(--card, #111)",k="var(--text, #e9e9e9)",u="var(--muted, #b7b7b7)",m="var(--border, #222)",v="var(--accent, #22c55e)",$="var(--radius, 16px)",A="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",G="var(--maxw, 1100px)",N=q`
  @media print {
    @page { margin: 18mm; }

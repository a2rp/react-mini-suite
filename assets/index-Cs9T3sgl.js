import{f as _,d as a,r as o,j as e}from"./index-CQ9Bvwu6.js";const I="var(--card, #111)",p="var(--text, #e9e9e9)",g="var(--muted, #b7b7b7)",i="var(--border, #222)",c="var(--accent, #22c55e)",E="var(--radius, 16px)",q="var(--shadow, 0 8px 30px rgba(0,0,0,.25))",B="10px",s="16px",R="24px",H=_`
  @media print {

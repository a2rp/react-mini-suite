import{d as m,f as Z,r,j as e}from"./index-CQ9Bvwu6.js";const I="var(--card, #111)",T="var(--text, #e9e9e9)",c="var(--muted, #b7b7b7)",d="var(--border, #222)",X="var(--accent, #22c55e)",D="var(--radius, 16px)",F="var(--shadow, 0 8px 30px rgba(0,0,0,.25))",_="var(--maxw, 1440px)",ee=m.section`
    max-width: ${_};
    margin: 0 auto;
    padding: 24px;
    color: ${T};

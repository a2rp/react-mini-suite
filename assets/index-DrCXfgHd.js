import{d as p,r,j as e}from"./index-CVh2HO98.js";const v="var(--bg)",S="var(--card)",g="var(--text)",J="var(--muted)",m="var(--border)",f="var(--radius)",H="var(--shadow)",N="var(--accent)",C="var(--danger, #e5484d)",o={Wrapper:p.div`
        color: ${g};
        background: ${v};
        padding: 16px;
        min-height: 100%;

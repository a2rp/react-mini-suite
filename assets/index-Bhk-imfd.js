import{d as l,r as m,j as e}from"./index-BNmCeOvN.js";const f="var(--bg)",b="var(--card)",j="var(--text)",v="var(--muted)",h="var(--border)",u="var(--radius)",W="var(--shadow)",F="var(--accent)",le="var(--danger, #e5484d)",n={Wrapper:l.div`
        color: ${j};
        background: ${f};
        min-height: 100%;
        padding: 16px;

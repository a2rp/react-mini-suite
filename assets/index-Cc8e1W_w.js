import{d as m,r,j as t}from"./index-CQ9Bvwu6.js";const oe="var(--card, #111)",H="var(--text, #e9e9e9)",L="var(--muted, #b7b7b7)",_="var(--border, #222)",P="var(--accent, #22c55e)",Q="var(--radius, 16px)",se=m.div`
    color: ${H};

import{d as l,f as G,r as b,j as e,y}from"./index-CQ9Bvwu6.js";const f="var(--bg)",$="var(--card)",m="var(--text)",A="var(--muted)",x="var(--border)",u="var(--radius)",z="var(--shadow)",v="var(--accent)",W="var(--danger, #e5484d)",F=G`
  @media print {
    /* hide everything */

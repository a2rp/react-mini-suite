import{d as l,g as G,r as b,j as e,y}from"./index-BNmCeOvN.js";const f="var(--bg)",$="var(--card)",m="var(--text)",A="var(--muted)",x="var(--border)",u="var(--radius)",z="var(--shadow)",v="var(--accent)",W="var(--danger, #e5484d)",F=G`
  @media print {
    /* hide everything */

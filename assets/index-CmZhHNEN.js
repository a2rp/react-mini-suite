import{d as o,r as j,j as e}from"./index-BNmCeOvN.js";const D="var(--card, #111)",v="var(--text, #e9e9e9)",f="var(--muted, #b7b7b7)",u="var(--border, #222)",$="var(--accent, #22c55e)",S="var(--radius, 16px)",A="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",C=`
  outline: 2px solid ${$};
  outline-offset: 2px;
`,N=`

import{d as k,r as p,j as e}from"./index-CQ9Bvwu6.js";const I="var(--card, #0f1012)",_="var(--text, #eaeaea)",H="var(--muted, #a8a8a8)",f="var(--border, #242424)",q="var(--accent, #22c55e)",be="var(--danger, #ef4444)",A="var(--radius, 16px)",P="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",N={Wrapper:k.div`
        color: ${_};
        display: grid;
        gap: 14px;
        max-width: 1440px;

import{d as l,r as n,j as t}from"./index-CVh2HO98.js";const le="var(--bg)",$="var(--card)",C="var(--text)",B="var(--muted)",S="var(--border)",R="var(--radius)",N="var(--shadow)",K="var(--accent)",A="var(--danger, #e5484d)",o={Wrapper:l.div`
        background: ${le};
        color: ${C};
        min-height: 100%;
        padding: 16px;

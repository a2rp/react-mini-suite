import{g as E,d as G,r as h,j as e}from"./index-BNmCeOvN.js";const U="var(--card, #111)",y="var(--text, #e9e9e9)",v="var(--muted, #b7b7b7)",x="var(--border, #222)",f="var(--accent, #22c55e)",N="var(--danger, #ef4444)",m="var(--radius, 16px)",D="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",F=E`
  @media print {

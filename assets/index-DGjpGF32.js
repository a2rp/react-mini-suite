import{d as p,r as o,j as e}from"./index-CQ9Bvwu6.js";const j="var(--bg)",b="var(--card)",a="var(--text)",$="var(--muted)",u="var(--border)",w="var(--radius)",_="var(--shadow)",y="var(--accent)",h="var(--danger, #e5484d)",i={Wrapper:p.div`
        color: ${a};
        background: ${j};
        min-height: 100%;
        padding: 16px;

import{d as l,r as d,j as e}from"./index-CVh2HO98.js";const u="var(--bg)",f="var(--card)",g="var(--text)",E="var(--muted)",t="var(--border)",w="var(--radius)",H="var(--shadow)",v="var(--accent)",b="var(--danger, #e5484d)",n={Wrapper:l.div`
        color: ${g};
        background: ${u};
        padding: 16px;
        min-height: 100%;

import{d as s,r as m,j as e}from"./index-CQ9Bvwu6.js";const p="var(--bg)",u="var(--card)",b="var(--text)",v="var(--muted)",l="var(--border)",d="var(--radius)",x="var(--shadow)",y="var(--accent)",D="var(--danger, #e5484d)",t={Wrapper:s.div`
        min-height: 100%;
        max-width: 1440px;
        margin: 0 auto;
        padding: 16px;

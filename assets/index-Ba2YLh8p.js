import{d,r as x,j as e}from"./index-CQ9Bvwu6.js";const L="var(--card, #111)",B="var(--text, #e9e9e9)",P="var(--muted, #b7b7b7)",$="var(--border, #222)",U="var(--accent, #22c55e)",V="var(--radius, 16px)",W="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",H="inset 0 1px 0 rgba(255,255,255,0.04)",I=d.div`
    background: ${L};
    border: 1px solid ${$};
    border-radius: ${V};
    box-shadow: ${W};

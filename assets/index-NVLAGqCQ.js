import{d as L,r as i,j as e}from"./index-BNmCeOvN.js";const I="var(--card, #111)",m="var(--text, #e9e9e9)",p="var(--muted, #b7b7b7)",h="var(--border, #222)",b="var(--accent, #22c55e)",P="var(--danger, #ef4444)",j="var(--radius, 16px)",U="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",W={Wrapper:L.section`
        max-width: 1120px;
        margin: 0 auto;
        padding: 24px;
        color: ${m};

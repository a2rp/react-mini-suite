import{d as s,o as K,r as l,j as e}from"./index-BNmCeOvN.js";const x="var(--bg)",f="var(--card)",u="var(--text)",g="var(--muted)",n="var(--border)",p="var(--radius)",z="var(--shadow)",$="var(--accent)",y="var(--danger, #e5484d)",B="#ef476f",R="#ffd166",Q="#06d6a0",o={Wrapper:s.div`
        max-width: 1440px;
        margin: 0 auto;
        display: grid;
        gap: 16px;

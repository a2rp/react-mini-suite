import{d as u,r as p,j as t}from"./index-CQ9Bvwu6.js";const L="var(--card, #0f1012)",f="var(--text, #eaeaea)",N="var(--muted, #a8a8a8)",h="var(--border, #242424)",j="var(--accent, #22c55e)",te="var(--danger, #ef4444)",y="var(--radius, 16px)",H="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",o={Wrapper:u.div`
        display: flex;

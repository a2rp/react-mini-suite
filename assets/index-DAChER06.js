import{d as c,r as g,j as t}from"./index-CQ9Bvwu6.js";const N="var(--card, #0f1012)",C="var(--text, #eaeaea)",M="var(--muted, #a8a8a8)",u="var(--border, #242424)",L="var(--accent, #22c55e)",z="var(--radius, 16px)",E="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",p={Wrapper:c.div`
        display: flex;

import{d as r,r as p,j as t}from"./index-CQ9Bvwu6.js";const g="var(--card, #0f1012)",c="var(--text, #eaeaea)",u="var(--muted, #a8a8a8)",s="var(--border, #242424)",b="var(--accent, #22c55e)",E="var(--danger, #ef4444)",h="var(--radius, 16px)",y="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",a={Wrapper:r.div`
        display: flex;

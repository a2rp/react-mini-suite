import{d as $,r as m,j as t}from"./index-CVh2HO98.js";const N="var(--card, #111)",C="var(--text, #e9e9e9)",R="var(--muted, #b7b7b7)",j="var(--border, #222)",T="var(--radius, 16px)",A="var(--shadow, 0 8px 30px rgba(0,0,0,.25))",v={Wrapper:$.section`

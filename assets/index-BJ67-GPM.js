import{d as l,r as n,j as e}from"./index-CVh2HO98.js";const M="var(--bg)",g="var(--card)",m="var(--text)",E="var(--muted)",u="var(--border)",b="var(--radius)",z="var(--shadow)",y="var(--accent)",te="var(--danger, #e5484d)",a={Wrapper:l.div`
        max-width: 1440px;
        margin: 0 auto;
        display: grid;
        gap: 16px;

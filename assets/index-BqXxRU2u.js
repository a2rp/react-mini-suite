import{d,f as ve,r as u,j as e}from"./index-CQ9Bvwu6.js";const S="var(--bg)",C="var(--card)",g="var(--text)",k="var(--muted)",f="var(--border)",j="var(--radius)",H="var(--shadow)",A="var(--accent)",F="var(--danger, #e5484d)",be=ve`
  @media print {
    /* hide everything */

import{d as m,r as n,j as a}from"./index-CVh2HO98.js";const F="var(--card, #111)",G="var(--text, #e9e9e9)",w="var(--muted, #b7b7b7)",b="var(--border, #222)",M="var(--accent, #22c55e)",g="var(--radius, 16px)",S="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",u={Wrapper:m.div`

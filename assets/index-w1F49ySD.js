import{d as s,r as n,j as e}from"./index-CVh2HO98.js";const _="var(--card, #111)",v="var(--text, #e9e9e9)",c="var(--muted, #b7b7b7)",d="var(--border, #222)",$="var(--accent, #22c55e)",S="var(--danger, #ef4444)",D="var(--radius, 16px)",U="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",a={Wrapper:s.section`
        color: ${v};
        background: ${_};
        border: 1px solid ${d};
        border-radius: ${D};

import{d as b,r as n,j as e}from"./index-CVh2HO98.js";const I="var(--bg)",y="var(--card)",f="var(--text)",v="var(--muted)",u="var(--border)",m="var(--radius)",P="var(--shadow)",j="var(--accent)",E="var(--danger, #e5484d)",h={Wrapper:b.div`
        color: ${f};
        background: ${I};
        min-height: 100%;
        padding: 16px;

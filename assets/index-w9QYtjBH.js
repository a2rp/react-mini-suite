import{d as n,r as a,j as e}from"./index-CQ9Bvwu6.js";const y="var(--card, #0f1012)",f="var(--text, #eaeaea)",p="var(--muted, #a8a8a8)",o="var(--border, #242424)",w="var(--accent, #22c55e)",le="var(--danger, #ef4444)",m="var(--radius, 16px)",j="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",l={Wrapper:n.div`
        display: flex;

import{d as l,r as x,j as e}from"./index-CVh2HO98.js";const b="var(--text, #eaeaea)",u="var(--muted, #a8a8a8)",g="var(--border, #242424)",f="var(--accent, #22c55e)",j="var(--radius, 16px)",N="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",S="var(--maxw, 960px)",$=l.section`
    max-width: ${S};
    margin: 0 auto;
    padding: 24px;
    color: ${b};

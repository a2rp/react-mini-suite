import{d,r as u,j as t}from"./index-BNmCeOvN.js";const I="var(--card, #0f1012)",p="var(--text, #eaeaea)",j="var(--muted, #a8a8a8)",g="var(--border, #242424)",P="var(--accent, #22c55e)",z="var(--radius, 16px)",A="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",f={Wrapper:d.div`
        display: flex;

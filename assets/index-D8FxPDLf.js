import{d as p,r as m,j as t,y as k}from"./index-CVh2HO98.js";const $="var(--card, #111)",b="var(--text, #e9e9e9)",y="var(--muted, #b7b7b7)",w="var(--border, #222)",f="var(--accent, #22c55e)",S="var(--radius, 16px)",C="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",u={Wrapper:p.div`

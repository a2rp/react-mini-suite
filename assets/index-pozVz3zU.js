import{d as c,r as j,j as t}from"./index-BNmCeOvN.js";const k="var(--text, #eaeaea)",A="var(--muted, #a8a8a8)",g="var(--border, #242424)",Y="var(--accent, #22c55e)",Q="var(--danger, #ef4444)",ae="var(--radius, 16px)",de="var(--shadow, 0 8px 28px rgba(0,0,0,0.30))",r={};r.Wrapper=c.div`

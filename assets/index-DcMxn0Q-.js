import{d as a,r as l,j as e}from"./index-CQ9Bvwu6.js";const G="var(--card, #111)",u="var(--text, #e9e9e9)",d="var(--muted, #b7b7b7)",h="var(--border, #222)",K="var(--radius, 16px)",T="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",P="var(--accent, #22c55e)",q="var(--danger, #ef4444)",J="var(--warn, #f59e0b)",W=`
  outline: none;

import{d as s,o as ie,r as b,j as e}from"./index-BNmCeOvN.js";const N="var(--bg)",$="var(--card)",w="var(--text)",D="var(--muted)",x="var(--border)",f="var(--radius)",J="var(--shadow)",U="var(--accent)",k="var(--danger, #e5484d)",a={Wrapper:s.div`
        max-width: 1440px;
        margin: 0 auto;
        display: grid;
        gap: 16px;

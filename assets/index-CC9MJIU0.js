import{d as f,r as l,j as t}from"./index-CVh2HO98.js";const $="var(--card, #0f1012)",g="var(--text, #eaeaea)",v="var(--muted, #a8a8a8)",u="var(--border, #242424)",N="var(--accent, #22c55e)",w="var(--radius, 16px)",C="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",d={Wrapper:f.div`
        display: grid;
        gap: 16px;
        color: ${g};
        padding: 15px;

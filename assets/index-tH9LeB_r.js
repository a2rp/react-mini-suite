import{d as n,r as i,j as e}from"./index-BNmCeOvN.js";const F="var(--bg)",j="var(--card)",u="var(--text)",b="var(--muted)",c="var(--border)",p="var(--radius)",$="var(--shadow)",se="var(--accent)",x="var(--danger, #e5484d)",s={Page:n.div`
        color: ${u};
        background: ${F};
        padding: 16px;
        max-width: 1440px;

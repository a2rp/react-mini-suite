import{d,r as p,j as t}from"./index-BNmCeOvN.js";const m="var(--card, #111)",x="var(--text, #eaeaea)",S="var(--muted, #a8a8a8)",g="var(--border, #242424)",b="var(--accent, #22c55e)",$="var(--radius, 16px)",v="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",l={Wrapper:d.div`
        max-width: 1200px;
        margin: 0 auto;

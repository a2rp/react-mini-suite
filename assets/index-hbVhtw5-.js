import{d as i,r as m,j as t}from"./index-CVh2HO98.js";const g="var(--card, #111)",x="var(--text, #e9e9e9)",l="var(--muted, #b7b7b7)",d="var(--border, #222)",N="var(--accent, #22c55e)",b="var(--radius, 16px)",f="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",S=`
  outline: 2px solid ${N};
  outline-offset: 2px;
`,D=i.main`
    width: 100%;

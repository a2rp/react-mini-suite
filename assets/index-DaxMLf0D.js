import{d as b,m as be,r as i,j as t}from"./index-CVh2HO98.js";const A="var(--bg)",E="var(--card)",$="var(--text)",F="var(--muted)",y="var(--border)",j="var(--radius)",N="var(--shadow)",C="var(--accent)",ne="var(--danger, #e5484d)",ve=be`

import{d as h,r as g,j as i}from"./index-CVh2HO98.js";const k="var(--card, #111)",y="var(--text, #e9e9e9)",E="var(--muted, #b7b7b7)",x="var(--border, #222)",v="var(--accent, #22c55e)",C="var(--danger, #ef4444)",M="var(--radius, 16px)",j="var(--shadow, 0 8px 30px rgba(0,0,0,.25))",T=h.section`

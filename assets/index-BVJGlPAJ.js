import{d as n,r as o,j as e}from"./index-CQ9Bvwu6.js";const E="var(--bg, #0b0b0b)",X="var(--card, #111)",g="var(--text, #e9e9e9)",l="var(--muted, #b7b7b7)",c="var(--border, #222)",m="var(--accent, #22c55e)",O="var(--danger, #ef4444)",b="var(--radius, 16px)",q="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",h="var(--space-2, 10px)",i="var(--space-3, 16px)",N="var(--space-4, 24px)",t={Wrapper:n.div`
        width: 100%;
        display: grid;

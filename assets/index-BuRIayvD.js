import{d as c,r,j as e}from"./index-CQ9Bvwu6.js";const G="var(--card, #0f1012)",s="var(--text, #eaeaea)",$="var(--muted, #a8a8a8)",p="var(--border, #242424)",b="var(--accent, #22c55e)",q="var(--danger, #ef4444)",y="var(--radius, 16px)",N="var(--shadow, 0 10px 30px rgba(0,0,0,0.35))",x={Wrapper:c.div`
        display: grid;
        gap: 16px;
        color: ${s};
        margin: auto;

import{d as b,r as x,j as e}from"./index-CQ9Bvwu6.js";const w="var(--bg, #0b0b0b)",S="var(--card, #111)",B="var(--text, #e9e9e9)",d="var(--muted, #b7b7b7)",p="var(--border, #222)",h="var(--accent, #22c55e)",q="var(--radius, 16px)",N="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",K="var(--maxw, 1440px)",y={Wrapper:b.div`
        max-width: ${K};
        margin: 0 auto;
        padding: 24px;

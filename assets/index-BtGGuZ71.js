import{d as n,r as a,j as e}from"./index-CVh2HO98.js";const V="var(--card, #111)",f="var(--text, #e9e9e9)",u="var(--muted, #b7b7b7)",l="var(--border, #222)",$="var(--accent, #22c55e)",Z="var(--radius, 16px)",Q="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",X="var(--maxw, 1080px)",ee=n.div`
    max-width: ${X};
    margin: 0 auto;
    padding: 24px;
    color: ${f};
